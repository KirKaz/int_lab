...
if (isset($data['do_signup'])){
    ...
    if (!empty($errors)) {
        ...
        $pg = pg_query($connection, "INSERT INTO users (mail, pass, name, login, birthday_date, city, about) VALUES ('$data[mail]', '$data[password]', '$data[name]', '$data[login]', current_date , 'Не указано', 'Не указано')");
...
<body>
    ...
    <p>У вас уже есть аккаует? <a href="login.html">Войдите<a></p>
